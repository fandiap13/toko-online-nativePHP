...
if (isset($_GET['email']) && isset($_GET['token'])) {
  ...
  $query = mysqli_query($conn, "SELECT * FROM users WHERE email_user = '$email' AND token_ganti_pass = '$token'");
...
if (isset($_POST['ubahpass'])) {
  ...
  if ($pesan_error == "") {
    ...
    $ubahpass = mysqli_query($conn, "UPDATE `users` SET `password` = '$password_baru', `token_ganti_pass` = NULL WHERE `email_user` = '$email'");
    if ($ubahpass) {
      echo "
			<script>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 align-item-center">
                <div class="border">
                    <h3 class="bg-gray p-4">Ubah Password Admin</h3>
                    <form method="POST">
                      <fieldset class="p-4">
